...
if __name__ == "__main__":
	...
	# 	business_collection.update({'_id': Y[i]}, {'$set': {'Demo_Cluster': int(labels[i])}}, upsert = True)
    #
	# for i in range(0, K):
	# 	cluster_collection.update({'_id': i}, {'$set': {'Centroid_Longitude': centroids[i][0], 'Centroid_Latitude': centroids[i][1]}})
