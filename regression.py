...
if __name__ == "__main__":
    ...
    B=np.random.randint(data_0am_train_x.shape[0],size=10)
    ...
    # print data_0am_train_xx.shape
    # print data_0am_train_yy.shape
    ...
    print "train error: " , np.sqrt(np.mean((data_0am_train_predy-data_0am_train_yy)**2))
    print "test error: ",  np.sqrt(np.mean((data_0am_test_predy-data_0am_test_y)**2))
